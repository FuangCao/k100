...
#define BATT_LED_GPIO_PORT		GPIO_PORT_0
#define BATT_LED_GPIO_PIN		GPIO_PIN_7
...
#define BT_LED_GPIO_PORT		GPIO_PORT_2
#define BT_LED_GPIO_PIN			GPIO_PIN_9
...
#define CHG_DET_GPIO_PIN		GPIO_PIN_1
...
#define CHG_DET_GPIO_CONFIG 	GPIO_ConfigurePin(CHG_DET_GPIO_PORT, CHG_DET_GPIO_PIN, INPUT_PULLUP, PID_GPIO, true)
