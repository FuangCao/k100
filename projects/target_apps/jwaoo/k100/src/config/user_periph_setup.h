...
#define RESISTOR_GPIO_PIN		GPIO_PIN_2
...
#define RESISTOR_OPEN			GPIO_SetInactive(RESISTOR_GPIO_PORT, RESISTOR_GPIO_PIN)
#define RESISTOR_CLOSE			GPIO_SetActive(RESISTOR_GPIO_PORT, RESISTOR_GPIO_PIN)
