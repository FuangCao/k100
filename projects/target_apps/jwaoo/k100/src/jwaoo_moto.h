...
#define JWAOO_MOTO_BOOST_STEP			1
#define JWAOO_MOTO_BOOST_DELAY			1

#define JWAOO_MOTO_LIMIT_LEVEL			JWAOO_PWM_LEVEL_MAX
#define JWAOO_MOTO_LIMIT_DELAY			10

#define JWAOO_MOTO_SAWTOOTH_SHORT		800
#define JWAOO_MOTO_SAWTOOTH_LONG		1600
#define JWAOO_MOTO_SQUARE_SHORT			700
#define JWAOO_MOTO_SQUARE_LONG			1400
