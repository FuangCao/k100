...
#define SUSPEND_KEY_PORT		KEY1_GPIO_PORT
#define SUSPEND_KEY_PIN			KEY1_GPIO_PIN
#define WAKEUP_KEY_SEL_MASK		WAKEUP_KEY_SELECT(WAKEUP_KEY_PORT, WAKEUP_KEY_PIN)
#define WAKEUP_KEY_POL_MASK		WAKEUP_KEY_POLARITY(WAKEUP_KEY_PORT, WAKEUP_KEY_PIN)
